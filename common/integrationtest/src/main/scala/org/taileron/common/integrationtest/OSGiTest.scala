...
package org.taileron.common.integrationtest
...
class OSGiTest extends Suite {
  ...
  addBundle("org.taileron", "taileron.scala-library", "2.7.3")
  addBundle("org.taileron", "taileron.common.integrationtest", "1.0.0")
